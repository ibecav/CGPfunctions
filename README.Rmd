...
```{r example3, echo=FALSE, fig.cap="Example newggslopegraph plot", out.width = '70%'}
knitr::include_graphics("https://ibecav.github.io/CGPfunctions/articles/Using-newggslopegraph_files/figure-html/ggslope6-1.png")
```
