...
Also from Tufte data about GDP.  I'll use it to show you a tricky way to hightlight certain countries without making a named vector with `LineColor = c(rep("gray",3), "red", rep("gray",3), "red", rep("gray",10))` the excess vector entries are silently dropped....
