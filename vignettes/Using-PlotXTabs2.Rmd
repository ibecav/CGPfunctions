...
2.  By default a simple summary of key frequentist and bayesian information is supplied but this subtitle can be suppressed.
...
Using a simple set of `dplyr` verbs we'll create a simple list of the variables we are interested in. Technically it's a vector but `purrr` will coerce it to a list. 
...
purrr::map2(.x = myvariables,
            .y = mytitles,
            .f =  ~ PlotXTabs2(x = tidyselect:::all_of(.x),
                               title = .y,
                               data = happy,
                               y = happy,
                               legend.title = "Rating",
