...
vignette: >
  %\VignetteIndexEntry{Plot2WayAnova}
...
```{r Plot2WayANOVA, echo=TRUE, message=TRUE, warning=FALSE, paged.print=TRUE}
CGPfunctions::Plot2WayANOVA(mpg~am*cyl, mtcars)
```
