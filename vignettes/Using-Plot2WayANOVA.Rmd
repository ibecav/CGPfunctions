...
real utility lies in the fact that it is pulled together in one function and
...
`Anova` you'll be presented with information about effect sizes like eta squared
